...
function InputGroup({
  ...
  return (
    ...
    >
      <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/30 ml-0.5">
        {label}
      </label>
...
function ContactInfo({
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/25 mb-0.5">
          {label}
        </p>
        <a
          href={href}
          className="text-sm font-medium text-white/70 group-hover:text-brand transition-colors duration-300"
        >
          {value}
        </a>
      </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-white/45 text-sm md:text-base leading-relaxed max-w-sm border-l-2 border-brand/30 pl-4">
                I'll do my best to get back to you within 24 hours. Don't
                hesitate to reach out every great project starts with a
                conversation.
              </p>
            </div>
            ...
            {/* Socials */}
            <div>
              <p className="font-mono text-[10px] text-white/25 uppercase tracking-[0.2em] mb-4">
                Find me on
              </p>
