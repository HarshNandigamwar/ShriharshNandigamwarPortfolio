  ...
  const projects = [
    {
      title: "CodeMates",
      description:
        "A high-performance social networking platform for developers. Share technical insights, network with peers, and collaborate in real-time.",
      tech: [
        "NextJS",
        "TypeScript",
        "Redux Toolkit",
      ...
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1771158619/STR_Dating_apps_blog_post_2024_V.1.0_hhuvbq.webp",
      featured: true,
      category: "Full Stack",
    },
    {
      title: "Sigma AI",
      description:
        "An advanced AI-powered chatbot built with Next.js and the Gemini API. Smart, responsive, and context-aware conversations in a beautifully styled web app.",
      ...
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/SigmaAI1_rv1xux.png",
      featured: true,
    ...
    },
    {
      ...
      description:
        "A full-stack e-commerce web application built with React.js and Firebase, delivering a smooth and engaging shopping experience.",
      ...
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761028463/Ecom1_tdmejk.png",
      featured: false,
      category: "Full Stack",
    },
    {
      title: "Weather App",
      description:
        "Check the weather forecast anytime, anywhere. Accurate and up-to-date weather updates for any location worldwide.",
      ...
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761028344/weather3_jqtyt7.jpg",
      featured: false,
      category: "Frontend",
    },
    {
      ...
      description:
        "Quickly convert currencies on the go with up-to-date exchange rates for countries worldwide.",
      ...
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761028243/Currency_Converter2_xi1lkh.png",
      featured: false,
      category: "Frontend",
    },
  ];
    ...
    >
      ...
      <div className="mx-auto px-3 ">
        ...
        >
          ...
          <p className="max-w-lg text-white/40 text-sm md:text-base leading-relaxed">
            A selection of things I've built from production apps to personal
            experiments.
          </p>
        </motion.div>
