...
const projects = [
    {
        ...
        tech: ["NextJS", "Tailwind CSS", "TypeScript", "Redux Toolkit", "Socket.io", "Axios", "Node.js", "Express.js", "MongoDB", "Cloudinary", "Mongoose"],
    ...
    },
    {
        ...
        tech: ["NextJS", "Tailwind CSS", "TypeScript", "Gemini-API", "Axios", "Motion"],
    ...
    },
    {
        ...
        description: "This is a FullStack E-Commerce web application built with React.js & Firebase designed to deliver a smooth and engaging shopping experience.",
        tech: ["React.js", "Firebase", "Tailwind CSS", "DummyJSON API", "Axios", "Motion"],
    ...
    {
        title: "Weather app",
        description: "Check the weather forecast anytime anywhere. Get accurate and up-to-date weather updates for your location.",
    ...
    },
    {
        ...
        description: "Quickly convert currencies on-the-go Get up-to-date exchange rates for countries worldwide.",
                        ...
                        >
                            ...
                            <div className="p-4 md:p-8">
                                <div className="flex justify-between items-start mb-4">
                                    <h3 className="text-2xl font-bold group-hover:text-brand transition-colors">{project.title}</h3>
                                    <div className="flex gap-4 items-center">
                                        <a href={project.github} target="_blank" title="view code" className="hover:text-brand transition-colors">
                                            <GithubIcon size={20} />
                                        </a>
                                        {project.githubbackend && (
                                            <a href={project.githubbackend} target="_blank" title="view code" className="hover:text-brand transition-colors">
                                                <GithubIcon size={20} />
                                            </a>
                                        )}

                                        <a href={project.live} target="_blank" title="live demo" className=" hover:text-brand transition-colors">
                                            <ExternalLinkIcon size={20} className="hover:text-blue-500" />
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="md:hidden flex flex-wrap gap-2">
                                    {project.tech.map((t, idx) => (
                                        <span key={t} className="text-[10px] uppercase tracking-wider font-mono px-3 py-1 rounded-full bg-brand/5 border border-brand/20 text-brand cursor-default">
                                            {t}
                                        </span>
                                    ))}
                                </div>
