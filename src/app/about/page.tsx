          ...
          <div ref={imageRef} className="hidden md:block relative">
            ...
            >
              ...
              >
                ...
                >
                  <p className="font-mono text-xs text-brand/80 tracking-widest uppercase">
          ...
          >
            ...
            <div className="space-y-5">
              {[
                ...
                <>
                  My journey in tech is fueled by a curiosity for real-world
                  problem solving. I specialise in the{" "}
                  <span className="text-brand font-semibold">MERN Stack</span>{" "}
                  and <span className="text-brand font-semibold">Next.js</span>,
            ...
            >
              <p className="font-mono text-xs text-white/30 uppercase tracking-[0.2em] mb-3">
                Tech I work with
              </p>
