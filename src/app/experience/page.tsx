    ...
    return (
      ...
      >
        <motion.span
          animate={{
            x: hovered ? 4 : 0,
            color: hovered ? "#22c55e" : "rgba(34,197,94,0.6)",
          }}
        ...
        <div className="relative flex gap-8 md:gap-14">
          ...
          <div className="relative flex flex-col items-center pt-1 shrink-0">
            ...
            <div className="relative w-px flex-1 mt-4 bg-white/[0.06] overflow-hidden rounded-full">
              <motion.div
                style={{ height: lineH }}
                className="absolute top-0 left-0 right-0 bg-gradient-to-b from-brand/60 to-brand/10 rounded-full"
              />
            </div>
            {/* End dot */}
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-brand/40 mt-2"
            />
          </div>
          ...
          <div ref={cardRef} className="flex-1 pb-12">
            ...
            >
              ...
              <p className="text-brand/80 font-mono text-sm tracking-wider">
            ...
            >
              ...
              >
                Developed multiple interactive and user-friendly web
                applications that enhance user experience and functionality
                focusing on responsiveness, usability, and efficiency.
              </motion.p>
              ...
              {/* Tech pills */}
              <div>
                <p className="font-mono text-[10px] text-white/25 uppercase tracking-[0.2em] mb-3">
                  Technologies
                </p>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="flex-1 space-y-3 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-2">
                    ...
                    <span className="font-mono text-xs text-brand uppercase tracking-[0.2em] font-bold">
                      Verified Credential
                    </span>
                  </div>
