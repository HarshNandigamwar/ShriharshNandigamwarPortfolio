...
const HomePage = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="home"
      className="relative flex flex-col md:flex-row md:items-center justify-between gap-12 overflow-hidden py-5 md:py-0 md:p-3"
    >
      {/*Background layers*/}
      <GridBackground />
      ...
      <motion.div
        ...
        className="flex md:hidden items-center justify-center relative z-10"
      >
      ...
      >
        ...
        >
          <span className="text-brand font-mono text-sm tracking-[0.2em] uppercase">
            Hi, my name is
          </span>
        </motion.div>
        ...
        <motion.div
          ...
          className="font-mono text-brand/80 text-lg md:text-xl mb-8 h-8 flex items-center"
        >
          <TypingText />
        </motion.div>
        ...
        >
          ...
          create value and grow as a coder.{" "}
          <span className="text-white/70">Let's connect</span> if you've got a
        ...
        <motion.div
          ...
          className="hidden md:flex gap-4 mb-10 flex-wrap justify-center md:justify-start"
        >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, transparent 0%, rgba(34,197,94,0.15) 50%, transparent 100%)",
          }}
        />
        <motion.div
          animate={{ rotate: -360 }}
        ...
        >
          ...
          {[
            ...
            <span
              key={i}
              className={`absolute w-6 h-6 border-brand/50 ${c} ${i === 0 ? "rounded-tl-lg" : i === 1 ? "rounded-tr-lg" : i === 2 ? "rounded-bl-lg" : "rounded-br-lg"}`}
            />
          ))}
