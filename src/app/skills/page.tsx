    ...
    return (
      ...
      >
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-br from-brand/8 via-transparent to-transparent -z-10"
        />
        ...
        {/* Title + description */}
        <div>
          <h3 className="text-xl font-bold text-white/90 mb-1.5 tracking-tight">
            {cat.title}
          </h3>
        ...
        <motion.div
          ...
          transition={{ duration: 0.4 }}
          className="h-px bg-gradient-to-r from-brand/30 to-transparent origin-left"
        />
  ...
  const FeatureChip = ({
    ...
    return (
      ...
      >
        ...
        <span className="font-mono text-sm text-white/60 whitespace-nowrap group-hover:text-white">
          {item.text}
        </span>
      </div>
    );
      ...
      <div className="mx-auto px-3">
        ...
        >
          {[
            ...
            >
              <span className="text-3xl font-black text-brand font-mono leading-none mb-1">
                {s.value}
              </span>
        ...
        <div className="hidden md:block">
          <p className="font-mono text-[10px] text-white/20 uppercase tracking-[0.25em] mb-5 text-center">
