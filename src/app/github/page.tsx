  ...
  const AnimatedNumber = ({
    ...
    return (
      <motion.span
        ...
        className="text-3xl font-black text-brand font-mono"
      >
        {value}
      </motion.span>
    );
  ...
  const StatCard = ({
    ...
    return (
      ...
      >
        ...
        <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-white/30 mb-1">
          {label}
        </p>
      ...
      <div className="mx-auto px-3">
        ...
        >
          ...
          <p className="max-w-lg text-white/40 text-sm md:text-base leading-relaxed">
            My daily contributions and coding consistency one commit at a time.
          </p>
        </motion.div>
            ...
            <div className="flex justify-center overflow-x-auto">
              {loading ? (
                <div className="flex flex-col items-center gap-4 py-8 w-full">
                  ...
                  <p className="font-mono text-xs text-brand/40 tracking-wider animate-pulse">
