    ...
    return (
        <section id="certificates" className="py-24 px-3 md:px-6 bg-transparent">
            <div className="max-w-7xl mx-auto">
                ...
                <motion.div initial={{opacity: 0, x: -20}} whileInView={{opacity: 1, x: 0}} className="flex items-center gap-2 text-brand font-mono mb-2">
                    <ShieldCheck size={20} />
                            ...
                            <div className="flex flex-col md:flex-row h-full">
                                ...
                                <div className="p-6 md:p-8 flex-1 flex flex-col">
                                    ...
                                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-brand/10">
                                        ...
                                        >
                                            <ExternalLinkIcon size={16} className="hover:text-blue-500" />
                                        </a>
                                    </div>
                                </div>
                            </div>
