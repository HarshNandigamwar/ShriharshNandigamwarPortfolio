...
export default function CertificationsPage() {
  ...
  const certifications = [
    {
      ...
      date: "2023",
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761029055/IBM_yyzqdd.png",
      description:
    ...
    },
    {
      ...
      date: "2024",
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761029046/Accenture_kcoo9d.png",
      description:
    ...
    },
    {
      ...
      date: "2024",
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761029051/AWS_yu4vat.png",
      description:
    ...
    },
    {
      ...
      date: "2025",
      image:
        "https://res.cloudinary.com/darmatnf2/image/upload/f_auto,q_auto/v1761029069/Hackathon_zfgblj.png",
      description:
    ...
    return (
      ...
      >
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-br from-brand/10 via-transparent to-transparent -z-10"
        />
        <motion.div
          animate={{ scaleX: hovered ? 1 : 0 }}
          transition={{ duration: 0.3 }}
          className="absolute top-0 left-0 right-0 h-px bg-brand origin-left"
        />
        <div>
          <Icon className="text-brand mb-3 w-5 h-5" />
        </div>
        <h4 className="font-semibold text-white/85 text-sm mb-1">
          {data.name}
        </h4>
  ...
  return (
    <section
      ref={sectionRef}
      id="certificates"
      className="relative py-10 md:py-16 px-3 md:px-6 overflow-hidden"
    >
      ...
      <div className="mx-auto">
        ...
        >
          ...
          <p className="max-w-lg text-white/45 text-sm md:text-base leading-relaxed">
            A curated collection of professional certifications and simulation
            programs that have sharpened my technical expertise.
          </p>
        </motion.div>
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2 text-brand mb-3">
                ...
                <span className="uppercase tracking-[0.2em] text-xs font-mono font-semibold">
                  Course Overview
                </span>
              </div>
              <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight mb-4 leading-snug">
                The Complete Fullstack Web Development Bootcamp
              </h2>
              <p className="text-white/45 text-sm md:text-base leading-relaxed border-l-2 border-brand/30 pl-4">
                A comprehensive journey from foundations to advanced software
                engineering covering modern, scalable web applications and
        ...
        >
          ...
          <h3 className="font-mono text-xs text-white/35 uppercase tracking-[0.2em]">
