...
const DownloadIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(({size = 24, color = "currentColor", strokeWidth = 2, className = ""}, ref) => {
    ...
    const start = useCallback(async () => {
        ...
        while (isAnimatingRef.current) {
            ...
            // 2. Tray "Weight" Pulse
            await animate(".tray", {y: [0, 2, 0], scale: [1, 1.05, 1]}, {duration: 0.3, ease: "easeOut"});
    ...
    return (
        ...
        >
            {/* Tray */}
            <motion.path className="tray" d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" style={{transformOrigin: "center bottom"}} />
